                          ...
                          <div style={{width:'65%', marginLeft:'15px'}}>
                             ...
                             <div className='message info'>
                                <Message color={optionOneColor} style={{marginTop:'10px', height:'115px'}}>
                                  <div>{ votedOptionOne ?<Label circular floating color='yellow'>Your Vote</Label> : <div></div> }
                             ...
                             <div>
                                <Message color={optionTwoColor} style={{marginTop:'10px',height:'115px'}}>
                                   <div> {votedOptionTwo ?<Label circular floating color='yellow'>Your Vote</Label> : <div></div> }
                                     <div style={{display:'flex',flexDirection:'column'}}>
